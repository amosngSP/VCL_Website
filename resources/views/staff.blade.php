  ...
  <div class="col">
    ...
    <div class="row" style="margin-bottom: 50px;">
      ...
      <div class="col- card staff-card">
        ...
        <div class="card-body">
          <h5 class="card-title">Vu Viet Phuong<br>ACCVCL1 - Director<br>ACCVCL5 - Events Director</h5>
    ...
    <div class="col- card staff-card">
        ...
        <div class="card-body">
          <h5 class="card-title">Amos Ng<br>ACCVCL4 - Operations Director<br>ACCVCL6 - Webmaster</h5>
